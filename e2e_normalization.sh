...
perl -0777 -pi.orig -e "s/United States/USA/gi" $input
...
#==========================================================
# (double)Corrections (that can be made sooner)
#==========================================================
perl -0777 -pi.orig -e "s/\bUS\b/USA/g" $output+5TTS.txt
...
#==========================================================
echo
rename -f 's/\+5TTS/_ATN/g' test+5TTS.txt # removing the afix in the file name
subl *_ATN*.txt
